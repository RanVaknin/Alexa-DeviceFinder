...
namespace AlexaDeviceFinderAuth.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public async Task<ActionResult<UserDevice>> GetUserDevice(string userId, string deviceId)
        {
        ...
        public async Task<ActionResult<IEnumerable<UserDevice>>> GetUserDevices(string userId)
        {
        ...
        public async Task<ActionResult> DeleteDevice(string userId, string deviceId)
        {
            try
            {
